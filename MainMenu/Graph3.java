...
public class Graph3 extends BaseGraph
{
    ...
    private void prepare() {
        ...
        addObject(new Node("A"), 200, 180);   
        addObject(new Node("B"), 340, 130);
        addObject(new Node("C"), 430, 140);
        addObject(new Node("D"), 545, 185);
        addObject(new Node("E"), 580, 245);
        addObject(new Node("F"), 490, 240);
        addObject(new Node("G"), 655, 215);
        addObject(new Node("H"), 455, 310);
        addObject(new Node("I"), 600, 330);
        addObject(new Node("J"), 505, 370);
        addObject(new Node("K"), 450, 400);
        addObject(new Node("L"), 380, 360);
        addObject(new Node("M"), 390, 275);
        addObject(new Node("N"), 365, 200);
        addObject(new Node("O"), 250, 300);
        addObject(new Node("p"), 275, 110);
        /*
